 ...
 */
internal class ToastTransform(private val project: Project) : BaseCustomTransform(true) {
    ...
    override fun provideFunction() = { ios: InputStream, zos: OutputStream ->
        ...
        try {
            ctClass.getDeclaredMethod("onCreate").also {
                ...
                if (null != attribute?.getAnnotation("com.example.toasttransformproject.Hello")) {
